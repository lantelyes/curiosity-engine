...
export const surveyTopics: SurveyTopic[] = [
  {
    ...
    ratePerMinute: 0.42,
    initialQuestion:
      "What are your favorite types of cuisine and how often do you dine out?",
  ...
  },
  {
    ...
    ratePerMinute: 0.45,
    initialQuestion:
      "How do you use technology in your daily life and what devices do you rely on most?",
  ...
  },
  {
    ...
    ratePerMinute: 0.5,
    initialQuestion:
      "What does a healthy lifestyle mean to you and what wellness practices do you follow?",
  ...
  },
  {
    ...
    ratePerMinute: 0.48,
    initialQuestion:
      "What are your favorite travel destinations and what type of traveler are you?",
  ...
  },
  {
    ...
    ratePerMinute: 0.4,
    initialQuestion:
      "How do you approach shopping and what influences your purchasing decisions?",
  ...
  },
  {
    ...
    ratePerMinute: 0.44,
    initialQuestion:
      "What types of entertainment do you enjoy and how do you spend your leisure time?",
